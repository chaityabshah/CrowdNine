...
module.exports = {
  ...
  db: process.env.MONGODB || process.env.MONGOLAB_URI || 'mongodb://admin:hackduke@ds053794.mongolab.com:53794/mongodongo',
  ...
  facebook: {
    clientID: process.env.FACEBOOK_ID || '1203669079649647',
    clientSecret: process.env.FACEBOOK_SECRET || 'f72e831ebfe959729bc673f04376050c',
  ...
  google: {
    clientID: process.env.GOOGLE_ID || '64822251932-ebq15ut73800c6f8jvko12150nhdtb5h.apps.googleusercontent.com',
    clientSecret: process.env.GOOGLE_SECRET || 'K6LFonUf3CEAK64KLGMMW5Rh',
